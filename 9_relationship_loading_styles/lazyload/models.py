...
class User(BaseModel):
    ...
    posts: Mapped[list["Post"]] = relationship("Post", back_populates="user", cascade="all, delete-orphan", lazy="select")
...
class Post(BaseModel):
    ...
    content: Mapped["Content"] = relationship("Content", back_populates="post", cascade="all, delete-orphan", lazy="select")
